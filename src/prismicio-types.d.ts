...
/**
 * Item in *Bento → Default → Primary → BentoRepeat*
 */
export interface BentoSliceDefaultPrimaryBentorepeatItem {
	/**
	 * Title field in *Bento → Default → Primary → BentoRepeat*
	 *
	 * - **Field Type**: Title
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentorepeat[].title
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	title: prismic.TitleField;

	/**
	 * Body field in *Bento → Default → Primary → BentoRepeat*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentorepeat[].body
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	body: prismic.RichTextField;

	/**
	 * Image field in *Bento → Default → Primary → BentoRepeat*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentorepeat[].image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
	image: prismic.ImageField<never>;

	/**
	 * Wide field in *Bento → Default → Primary → BentoRepeat*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: bento.default.primary.bentorepeat[].wide
	 * - **Documentation**: https://prismic.io/docs/field#boolean
	 */
...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * BentoRepeat field in *Bento → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentorepeat[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	bentorepeat: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryBentorepeatItem>>;
}
...
/**
 * Item in *CaseStudies → Default → Primary → linkzone*
 */
export interface CaseStudiesSliceDefaultPrimaryLinkzoneItem {
	/**
	 * Case Study field in *CaseStudies → Default → Primary → linkzone*
	 *
	 * - **Field Type**: Content Relationship
	 * - **Placeholder**: *None*
	 * - **API ID Path**: case_studies.default.primary.linkzone[].case_study
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
...
export interface CaseStudiesSliceDefaultPrimary {
	...
	/**
	 * linkzone field in *CaseStudies → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: case_studies.default.primary.linkzone[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	linkzone: prismic.GroupField<Simplify<CaseStudiesSliceDefaultPrimaryLinkzoneItem>>;
}
...
/**
 * Item in *Integrations → Default → Primary → Repeat*
 */
export interface IntegrationsSliceDefaultPrimaryRepeatItem {
	/**
	 * Icon field in *Integrations → Default → Primary → Repeat*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.repeat[].icon
...
export interface IntegrationsSliceDefaultPrimary {
	...
	/**
	 * Repeat field in *Integrations → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.repeat[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	repeat: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryRepeatItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			CaseStudiesSlice,
			CaseStudiesSliceDefaultPrimaryLinkzoneItem,
			...
			HeroSliceDefault,
			IntegrationsSlice,
			IntegrationsSliceDefaultPrimaryRepeatItem,
